...
if __name__ == '__main__':
    ...
    MyHouse = Housing('/Py/MyHouse/B4_H4_11_02_2011.csv','/Py/MyHouse/PriceSignal.csv')
                    ...
                    try:            
                        ...
                        for i in range(len(Sub_Prices_1)):
                            ...
                            try:
                                ...
                                None
                                #print("Could not assign incoming data to cost on my problem!")
